...
**Current Version — Three-Distance Judge Demo + LLM Memory + Tokyo 23-Ward Community Map + 自作Community Open Data Build 2026-08-24**
...
- 自作の[東京23区 地域コミュニティDataset](https://github.com/Jun0908/tokyo_community_data)10,033件をMapへ表示。団体自身の座標、確認済み施設、区役所の順に位置を解決し、1,816件を区役所集約から分散。`話す`のLLM Groundingにも根拠付きで接続
...
`/osekkai/map`は麹町を中心とするGoogle Map上で、座標を確認できたEventと、自作Dataset由来の東京23区の地域コミュニティを一緒に探せます。地域コミュニティは`すべて / スポーツ / 音楽・文化 / 学習 / 交流・貢献`のジャンルで絞り込めます。Markerから開催時刻・移動時間・料金・募集状態・交流根拠・Sourceを確認でき、`今日 / 今週末 / ひとり参加可 / 継続あり`などで絞り込めます。

## 利用予定のデータ

| Source | 用途 | Plan2上の扱い |
|---|---|---|
| 自作: [Tokyo Community Data](https://github.com/Jun0908/tokyo_community_data) | 東京23区の18〜65歳向け地域コミュニティ・活動情報を公式Sourceから収集・正規化した独自Dataset（10,033件、2026-08-24時点） | 23区Map（284地点）とLLM Groundingへ統合済み |
