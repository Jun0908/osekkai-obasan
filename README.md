...
`/osekkai/map`はGoogle Map上で、座標を確認できたEventと、自作Dataset由来の東京23区の地域コミュニティを一緒に探せます。地域コミュニティは`すべて / スポーツ / 音楽・文化 / 学習 / 交流・貢献`のジャンルで絞り込めます。Markerから開催時刻・移動時間・料金・募集状態・交流根拠・Sourceを確認でき、`今日 / 今週末 / ひとり参加可 / 継続あり`などで絞り込めます。
